"""Phase 2 — Mô hình dữ liệu 2 bảng Master phục vụ Dashboard.
  ...
  Summary_Order_Items  (Profit_Phase2_summary_order_items)  — chi tiết theo đơn hàng,
      đúng cấu trúc cột file CSV "Order Items" mẫu của Sellerboard.
  Summary_Products     (Profit_Phase2_summary_products)     — tổng hợp theo (ASIN, SKU),
...
T_SUMMARY_PRODUCTS      = "Profit_Phase2_summary_products"
T_SUMMARY_CAMPAIGNS     = "Profit_Phase2_summary_campaigns"
T_SUMMARY_REIMBURSEMENTS = "Profit_Phase2_summary_reimbursements"
...
class SummaryReimbursement:
    """1 dòng = 1 (adjustment_type, asin, sku) gộp trong kỳ — từ Profit_Phase1_fin_adjustments
