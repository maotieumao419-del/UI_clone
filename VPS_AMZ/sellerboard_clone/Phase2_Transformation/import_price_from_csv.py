"""Phase 2 — Seed/override giá vào NEW_product_price từ file "Products" của Sellerboard.

Bảng NEW_product_price tự tích lũy giá từ đơn Shipped (Phase 1). Nhưng SKU mới
